    ...
    <body id="page-top">
        ...
        <header class="masthead bg-white text-secondary text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image--><img class="masthead-avatar mb-5" src="<?php echo base_url('assets/halutama/assets/img/portfolio/logo_wk.png') ?>" alt="" /><!-- Masthead Heading-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Aplikasi Rapot Digital SMK Wikrama Bogor</p>
            </div>
        </header>
        <!-- Portfolio Section-->
